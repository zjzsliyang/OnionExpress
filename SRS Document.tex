...
\begin{figure}[htbp]
  \centering\includegraphics[width=6in]{DocumentRes/5UseCaseDiagram.png}
  \caption{Scenario 5}
\end{figure}
...
\begin{tabular}{| c | l |}
  ...
  \hline
  Related Requirement & Scenario Five\\
  \hline
  Goal In Context & The customer needs to pay for the product after he/she has\\
  & placed the product or received the product.\\
  \hline
  ...
  \hline
  Trigger & Step1 Customer chooses one acceptable way to pay for the product.\\
...
\begin{figure}[htbp]
  \centering\includegraphics[width=6in]{DocumentRes/6UseCaseDiagram.png}
  \caption{Use Case Diagram Scenario6}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \caption{Record Damage}
\end{figure}

\subsubsection{Scenario 7}
\begin{figure}[htbp]
  \centering\includegraphics[width=6in]{DocumentRes/7UseCaseDiagram.png}
  \caption{Use Case Diagram Scenario7}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \caption{Make Returning Request}
\end{figure}

\subsubsection{Scenario 8}
\begin{figure}[htbp]
  \centering\includegraphics[width=6in]{DocumentRes/8UseCaseDiagram.png}
  \caption{Use Case Diagram Scenario8}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \caption{Get Package Track Inmformation}
\end{figure}
